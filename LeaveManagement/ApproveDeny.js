...
export default class ApproveDeny extends Component {
    ...
    ShowSpecificLeave(e){
        ...
        axios.get("http://localhost:50735/api/LeaveManagementDetails/ShowSpecificLeave/"+leaveId)
        .then(Response=>{
            this.setState({
    ...
    update(approveordeny)
    {
        ...
        axios.post("http://localhost:50735/api/LeaveManagementDetails/AcceptDeny/"+leaveId+"/"+status+"/"+managerComment,
        {
